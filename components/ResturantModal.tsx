  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your restaurant registration was successful.",
      });
    } catch (error) {
      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 mx-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Join thousands of restaurants growing with Giveat
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg transition mt-8 disabled:opacity-60"
          >
